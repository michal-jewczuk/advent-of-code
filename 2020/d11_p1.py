...
def count_taken_seats_close(coords, grid):
    ...
    for offset in offsets:
        row = coords[0] + offset[0]
        col = coords[1] + offset[1]
...
def should_seat_change_state(coords, grid):
    ...
    if seat == 0:
        ...
        return count_taken_seats_close(coords, grid) == 0
    elif seat == 2:
        return count_taken_seats_close(coords, grid) > 3
    else:
        return False
